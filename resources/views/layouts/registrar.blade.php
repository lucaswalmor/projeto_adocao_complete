            ...
            <div class="container d-flex justify-content-start">
                <div class="formulario">
                    ...
                    <form class="row g-3 needs-validation" novalidate method="post">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <input type="text" class="form-control" placeholder="Rua" aria-label="Rua" disabled
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="Bairro" aria-label="Bairro" disabled
                                    name="bairro" id="bairro" required>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="Cidade" aria-label="Cidade" disabled
